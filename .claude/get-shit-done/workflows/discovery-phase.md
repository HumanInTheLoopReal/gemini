...
/gsd:research-phase instead, which produces RESEARCH.md. </purpose>
...
**Output:** `.planning/phases/XX-name/DISCOVERY.md` </step>
...
**Output:** `.planning/phases/XX-name/DISCOVERY.md` (comprehensive) </step>
...
- Output structure for DISCOVERY.md </step>
