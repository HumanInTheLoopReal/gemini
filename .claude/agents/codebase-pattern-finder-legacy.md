...
description:
  ...
  for! It's sorta like codebase-locator, but it will not only tell you the
  location of files, it will also give you code details!
...
to search: What to look for based on request:
