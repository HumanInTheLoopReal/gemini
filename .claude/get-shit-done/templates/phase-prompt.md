...
[Relevant source files:] @src/path/to/relevant.ts </context>
...
@src/relevant/source.ts </context>
```
...
Output: User model, API endpoints, and UI components. </objective>
