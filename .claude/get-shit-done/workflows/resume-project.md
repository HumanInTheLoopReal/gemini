...
"Where were we?" should have an immediate, complete answer. </purpose>
...
**If STATE.md exists:** Proceed to load_state **If only ROADMAP.md/PROJECT.md
exist:** Offer to reconstruct STATE.md **If .planning/ doesn't exist:** This is
a new project - route to /gsd:new-project </step>
...
- Cloning repo without full .planning/ state </reconstruction>
