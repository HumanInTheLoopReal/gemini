...
- `{slug}`: Generated from truth </step>
...
- Include remaining possibilities from agent return </step>
...
next steps - verify-work handles the rest. </step>

</process>

<context_efficiency> **Orchestrator context:** ~15%
...
**No symptom gathering.** Agents start with symptoms pre-filled from UAT. **No
fix application.** Agents only diagnose - plan-phase --gaps handles fixes.
</context_efficiency>
