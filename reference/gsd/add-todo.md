...
Enables "thought → capture → continue" flow without losing context or derailing
...
- `files`: Relevant paths with line numbers from conversation </step>
...
**If `COMMIT_PLANNING_DOCS=false`:** Skip git operations, log "Todo saved (not
