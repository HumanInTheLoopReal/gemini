...
This is the brownfield equivalent of new-project. The project exists, PROJECT.md
has history. This command gathers "what's next", updates PROJECT.md, then
continues through the full requirements → roadmap cycle.
...
<execution_context> @./.claude/get-shit-done/references/questioning.md
...
@.planning/MILESTONE-CONTEXT.md </context>
...
Read MILESTONES.md to find the last phase number from previous milestone. New
phases continue from there (e.g., if v1.0 ended at phase 5, v1.1 starts at phase
6).
...
lost, artifacts persist. </success_criteria>
